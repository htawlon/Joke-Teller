...
async function getJokes(){
    let joke='';
    const apiUrl='https://v2.jokeapi.dev/joke/Programming,Miscellaneous,Dark,Christmas?blacklistFlags=nsfw,religious,political,racist,sexist,explicit';
    try{
       ...
       const data=await response.json();
        ...
        //Disable Buttom
        toggleButton();
        console.log(joke);   //for target of the joke
    }catch(error)
    {
